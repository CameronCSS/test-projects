...
(  .  .-'_/  )\ `"/  \  ) / |  | \ `'   /|  (_,_)\  | |   | |(_,_)    |   `-'  /
 `-'`-'     /  '. \_/``".'  |  |  \    / |  |    |  | |   | |   |      \      /
  ...
  This script has been modified by @wesbos becausehttps://twitter.com/wesbos/status/1657012836403388416
...
var cornify_updatecount = function () {
  ...
  if (p == null) {
    ...
    p.style.fontFamily = "'Press Start 2P', cursive"; // Using Press Start 2P font
    p.style.textTransform = "uppercase";
    var body = document.getElementsByTagName("body")[0];
    body.appendChild(p);    
  }
  ...
  if (cornify_count == 1) {
    ...
    // My edit just for this project
    p.innerHTML = "KONAMI CODE ENTERED!!";
  } else {
    // ORIGINAL
    // p.innerHTML = "You cornified " + cornify_count + " times!";
    // My edit just for this project
    p.innerHTML = "KONAMI CODE ENTERED!! <br> <sub>Refresh page to reset<sub>";
  }
